...
export class SessionManager  {
  ...
  constructor(config:{}, callback:(err:any)=>void){
    ...
    this.redisClient.on("end", function (err:any) {
  ...
  */
  ...
  retrieveConnectedNode(app:string, roomID:string, callback:(err:any,result:any)=>void) {
    ...
    async.parallel(
      [
        (asyncCB:()=>void)=>{
          ...
          this.redisClient.smembers(ukey, function (err:any, res:any) {
            userInfo=res
        ...
        (asyncCB:()=>void)=>{
          this.redisClient.get(skey, function (err:any, res:any) {
